...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#tech_add_ref").attr('disabled', 'disabled');
...
//            $("#add_to_list").removeAttr("disabled");
        ...
        $("#char_description").bind("keyup", function () {
            var x = this.value;
            if (x.length >= 30) {
                x = x.substring(0, 30);
                document.getElementById("char_description").value = x;
                sm_warning("Char Description Can Only Enter 30 char");
            }
        });
...
<div id="page-wrapper">
                        ...
                        <div class="form-horizontal">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <!--<input type="text" name="supplier_number" id="supplier_number"  autocomplete="off" style="height: 30px;"  class="form-control" value="<%=user.getCompanyId().getCompanyCode()%>"/>-->
                    ...
                    <div class="form-horizontal">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <!--<input class="form-control" list="tog_list" name="tog_value" id="tog_value" style="width: 100%; height: 30px;" value="0.0"/>-->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="col-sm-4" for="supplier_number">Select Department :</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4" for="uk_ean_no">UK EAN Number :</label>
                                <div class="col-sm-8">
                                    <input type="text" name="uk_ean_no" id="uk_ean_no" autocomplete="off" style="height: 30px; text-transform: capitalize;" class="form-control" >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4" for="ce_ean_no">CE EAN Number :</label>
                                <div class="col-sm-8">
                                    <input type="text" name="ce_ean_no" id="ce_ean_no" autocomplete="off" style="height: 30px; text-transform: capitalize;" class="form-control" >
                                </div>
                            </div>
                        </div>
                        <div id="sizes" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="col-sm-8" style="height: 30px;">
                                    <!--<input id="vccran" type="button" value="vccran" class="btn btn-primary" onclick="saveEan();">-->
                                </div>
                            </div>
                            <div id="uk_div" class="form-group">
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="uk_size" id="uk_size" list="uk_prim_size" placeholder="UK Size" style="width: 100%;">
                                    <datalist id="uk_prim_size">                           
                                        <option disabled="" selected=""> - Primary Size - </option>
                                    </datalist>  
                                </div>
                            </div>
                            <div id="ce_div" class="form-group">
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="ce_size" id="ce_size" list="ce_prim_size" placeholder="CE Size" width="100%" style="width: 100%;">
                ...
                <div class="panel panel-default" style="border-radius:">
                    <div style="padding: 10px 15px;">
                        <div class="col-lg-4">
                            <h4>'Secondary Sizes</h4>
                        </div>
                        <div class="col-lg-8">                            
                            <div class="form-group pull-right">
                                <div class="col-sm-2">
                                    <input id="add_to_list" type="button" value="Add To List" class="btn btn-primary" onclick="checkSecSizeSelectedOrNot();">
                                </div>
                            </div>
                            <div class="form-group pull-right">
                                <div class="col-sm-2">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-10">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group" style="width: 100%;">
                                                        <input type="text" class="form-control" name="ean_no1" id="ean_no1" placeholder="EAN Number" style="width: 100%;" onkeypress="return checkForSecondDecimal(this, event);"  onblur="checkExistEAN();">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group"> 
    ...
    <div class="col-lg-5">
        <div class="form-group">
            <div class="col-sm-2">
                <input id="check_none1" type="checkbox" value="" class="btn btn-primary" >
            </div>
            <label class="col-sm-10" for="check_none">Drop Secondary Sizes</label>
        </div>
    </div>
...
<br>
<div class="row">
    <div id="checkboxlist1" style="padding-left: 75px;">
        <div class="row" id="secView1" style="display: block;"><div class="col-lg-2 form-inline"><div class="form-group"><input type="checkbox" class="form-control" name="secSizeCheck" value="Height" id="Height"><label class="control-label"> &nbsp; &nbsp;Height</label></div></div><div class="col-lg-2 form-inline"><div class="form-group"><input type="checkbox" class="form-control" name="secSizeCheck" value="Chest" id="Chest"><label class="control-label"> &nbsp; &nbsp;Chest</label></div></div><div class="col-lg-2 form-inline"><div class="form-group"><input type="checkbox" class="form-control" name="secSizeCheck" value="Waist" id="Waist"><label class="control-label"> &nbsp; &nbsp;Waist</label></div></div></div>
    </div>
</div>
</div>
<div class="col-lg-2">
<div class="row">
    <input type="button" id="addToTable1" value="Add to Table [1]" class="btn btn-primary pull-right" style="width: 100%; margin: 5px;" onclick="addEanTable();">
</div>
<div class="row">
    ...
    <input type="button" value="Save EAN No &amp; Sizes [3]" id="Save_EAN" class="btn btn-primary pull-right" style="width: 100%; margin: 5px;" onclick="getEanDetail()">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table class="table table-striped table-hover table-bordered" width="100%" id="eanTable">
                            ...
                            <tbody style="text-align: center;">
                                ...
                                <!--                        <tr>
                                                            <td>
                                                                <input type="checkbox" id="0 " disabled="" name="chk_ean">
                                                            </td>
                                                            <td>
                                                                <div id="secSizeDiv">
                                                            ...
                                                            <td>
                                                                <input type="number" min="0" class="form-control" name="quantity" id="quantity" placeholder="Amount" style="width: 100%" onkeypress="javascript: return checkForSecondDecimal(this, event);">
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control" name="color" id="color" placeholder="Color" style="width: 100%">
                                                            </td>
                                                            <td>
                                                                <span id="0 " class="btn btn-default glyphicon glyphicon-remove text-center"></span>
                                                            </td>
                                                        </tr>-->
                            </tbody>
                        </table>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group pull-right">
                            <div class="col-sm-2">
                                <input id="save_ean" type="button" value="Save" class="btn btn-primary" onclick="getEanDetail();">
                            </div>
                        </div>
                    </div>
                </div> 
...
//        var carton_dimensions = document.getElementById('carton_dimensions').value.trim();
        ...
        if (style > 0) {
            if (style === 1) {
                ...
                if (style_no_uk === "" || style_no_uk === null) {
                    BootstrapDialog.alert('Please Enter Style No', function () {
                        $('html, body').animate({
        ...
        if (supplier_number === "" || supplier_number === null) {
            BootstrapDialog.alert('Please Enter Supplier No', function () {
                $('html, body').animate({
        ...
        } else if (season_code === "" || season_code === null) {
            BootstrapDialog.alert('Season Code reqiured.', function () {
                $('html, body').animate({
                    scrollTop: $("#season_code").offset().top - 125},
                'slow', function () {
                    $("#season_code").focus();
                });
                return;
...
//                    document.getElementById("btn_save_general").disabled = true;
        ...
        xmlHttp.open("POST", "/UnipointWebPortal/SaveOrder?actionType=generalData&generalData=" + jsonDetails, true);
        xmlHttp.send();
...
<script type="text/javascript">
    ...
    function getAllPrimarySize() {
        ...
        xmlHttp1.open("POST", "Controller?method=getAllPrimarySize&dept", true);
        xmlHttp1.send();
    }
...
//        }
    ...
    function addEanDetails() {
        ...
        if (ean_no === "" || ean_no === null) {
            sm_alert("Please Enter EAN No");
            return;
        } else if (uk_size === "" || uk_size === null) {
            sm_alert("Please Enter UK Size");
            return;
        } else if (ce_size === "" || ce_size === null) {
            sm_alert("Please Enter CE Size");
            return;
        } else {
            ...
            xmlHttp1.onreadystatechange = function ()
            {
                if (xmlHttp1.readyState === 4 && xmlHttp1.status === 200)
                {
                    ...
                    if (message === 1) {
                        ...
                        Gsize ["uk_ean_no"] = data.ean_details.uk_size;
//                        Gsize ["ce_ean_no"] = data.ean_details.ce_size;
                        var uk_size = document.getElementById("uk_size").value;
                        var ce_size = document.getElementById("ce_size").value;
                        ...
                        if (tmpuk != 1) {
                            sm_alert("Selected Department and Ean Number Don't Match, Please Check");
                        }
//                        if (id == "uk_ean_no") {
...
//                            sm_alert("Selected Department and Ean Number Dosen't Match, Please Check");
//                        }
//                        $("uk_div Option").each(function(){alert($(this));});
//                        document.getElementById("btn_add_sys").disabled = true;
//                        document.getElementById("btn_add_tab").disabled = false;
//                        document.getElementById("uk_size").readOnly = true;
//                        document.getElementById("ce_size").readOnly = true;
                    } else if (message === 0) {
                        saveid [id] = "new";
...
//                    document.getElementById("check_sec_size").disabled = false;
    ...
    function checkSecSizeSelectedOrNot() {
        ...
        for (var x = 0; x < table.rows.length; x++) {
            var rw = table.rows[x];
            var eanDetailNo = rw.cells[1].innerHTML;
            if (uk_ean_no === eanDetailNo || ce_ean_no === eanDetailNo) {
                isExist = true;
                break;
            }
        }
            ...
            if (dept.trim() != "Department") {
                ...
                if (!isChecked) {
                    ...
                    if ($('#checkboxlist input').length === 1) {
                        ...
                        if (ch.length === 0) {
                            sm_warning("Please Select Secondary Sizes or Drop Secondary Sizes.");
                        } else {
                            addToList();
                        }
                    }
                ...
                sm_warning("Please Select Relevent Department");
            }
        }
...
//        document.getElementById("check_sec_size").disabled = true;
    ...
    function addEanTable() {
        var ean_no = document.getElementById("uk_ean_no").value.trim();
...
<script type="text/javascript">
    ...
    function addFiber() {
        ...
        var fiberQuantity12 = parseInt(document.getElementById("fiberQuantity").value);
...
//            });
            ...
            sm_alert("Please Enter Wash Symbol");
            $('html, body').animate({
                scrollTop: $("#techWash_W").offset().top - 125},
            'slow', function () {
                $("#techWash_W").focus();
