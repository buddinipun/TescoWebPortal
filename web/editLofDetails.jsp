...
<%  SysUser user = (SysUser) session.getAttribute("user");
    ...
    if (user != null) {
        String techData = (String) request.getParameter("orderid");
        // System.out.println(techData);
        String lofID;
        Check_lof chk = new Check_lof();
        LofGeneraldata gData = chk.getGeneralDataByLofId(techData);
        if (gData.getConfOrder().equals("NAR")) {
            lofID = gData.getLofData();
        } else {
            String[] arr = techData.split("_");
            int tmp = Integer.valueOf(arr[3]);
            tmp = tmp + 1;
            lofID = arr[0] + "_" + arr[1] + "_" + arr[2] + "_" + String.valueOf(tmp);
            // System.out.println(lofID + "vccran");
        }

        List<LofEandata> eanSendList = chk.getEAN(gData.getWebOrderNo());
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#addToTable1").attr("disabled", "disabled");
        $("#check_none").attr("disabled", "disabled");

        var dept = document.getElementById("department_ID").value.trim();
        if (dept == "Department") {
            $("#Secondary_Sizes").attr("disabled", "disabled");
        }


        $("#department_ID").bind('input', function () {
            $("#Secondary_Sizes").removeAttr("disabled");
        });

        $("#Save_EAN").attr("disabled", "disabled");
        ...
        var po_number_uk = "<%=gData.getPurchaseOrderUk()%>";
        var po_number_ce = "<%=gData.getPurchaseOrderCe()%>";
        var style_no_uk = "<%=gData.getStyleNoUk()%>";
        var style_no_ce = "<%=gData.getStyleNoCe()%>";
...
//                checkForStyle();
                $("#style_ce_type").show();
                $("#style_uk_type").hide();
                document.getElementById("po_ce").value = po_number_ce;
                document.getElementById("style_ce").value = style_no_ce;
    ...
    function getTechDetails() {
        ...
        xmlHttp1.onreadystatechange = function ()
        {
            if (xmlHttp1.readyState === 4 && xmlHttp1.status === 200)
            {
                ...
                console.log(data);
                if (data.message) {
                    displayTechnical(data.tech_details);
                }
            }
        };
        xmlHttp1.open("POST", "Controller?method=getTechLabels&orderId=" + orderiD, true);
        xmlHttp1.send();

    }

    function getSwingDetails() {
    ...
    <div class="container-fluid" style="margin-top: 45px;" id="general_container">
                        ...
                        <div class="form-horizontal">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="supplier_number" id="supplier_number"  autocomplete="off" style="height: 30px;"  class="form-control" value="<%=gData.getSupplierCode()%>"/>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <%
                                            if (gData.getFactoryCode() == null) {
                                        %>
                                        <input type="text" name="factory_code" id="factory_code" autocomplete="off" style="height: 30px;"  class="form-control"/>
                                        <%
                                        } else {
                                        %>
                                        <input type="text" name="factory_code" id="factory_code" autocomplete="off" style="height: 30px;"  class="form-control" value="<%=gData.getFactoryCode()%>" />
                                        <%
                                            }
                                        %>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <%
                                            if (lofID == null) {
                                        %>
                                        <input type="text" name="lof_num" id="lof_num" style="height: 30px;"  autocomplete="off" class="form-control" value="" readonly/>
                                        <%
                                        } else {
                                        %>
                                        ...
                                        %>
                                        <!--                                        <input type="text" name="lof_num" id="lof_num" style="height: 30px;"  autocomplete="off" class="form-control" value="" readonly/>-->
                                        <input type="hidden" name="order_id" id="order_id" value="<%=gData.getWebOrderNo()%>" />
                                        <input type="hidden" name="web_order_id" id="web_order_id" value="<%=gData.getId()%>"/>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="panel panel-default">
                    ...
                    <div class="form-horizontal">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <%
                                        if (gData.getCategory() == null) {
                                    %>
                                    <input type="text" name="category" id="category"  autocomplete="off" style="height: 30px;"  class="form-control"/>
                                    <%
                                    } else {
                                    %>
                                    <input type="text" name="category" id="category"  autocomplete="off" style="height: 30px;"  class="form-control" value="<%=gData.getCategory()%>"/>
                                    <%
                                        }
                                    %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <%
                                        if (gData.getCountryOfOrigin() == null) {
                                    %>
                                    <input class="form-control" list="country_list" name="country_of_origin" id="country_of_origin" style="width: 100%; height: 30px;"/>
                                    <%
                                    } else {
                                    %>
                                    <input class="form-control" list="country_list" name="country_of_origin" id="country_of_origin" style="width: 100%; height: 30px;" value="<%=gData.getCountryOfOrigin()%>"/>
                                    <%
                                        }
                                    %>
                                    <!--// <input class="form-control" list="country_list" name="country_of_origin" id="country_of_origin" style="width: 100%; height: 30px;"/>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <%
                                        if (gData.getBrand() == null) {
                                    %>
                                    <input type="text" name="Brand" id="Brand"  autocomplete="off" style="height: 30px;"  class="form-control"/>
                                    <%
                                    } else {
                                    %>
                                    <input type="text" name="Brand" id="Brand"  autocomplete="off" style="height: 30px;"  class="form-control" value="<%=gData.getBrand()%>"/>
                                    <%
                                        }
                                    %>
                                    <!--                                    <input type="text" name="Brand" id="Brand"  autocomplete="off" style="height: 30px;"  class="form-control"/>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <%
                                        if (gData.getCharactorTfDes() == null) {
                                    %>
                                    <input type="text" name="char_description"  autocomplete="off" id="char_description" style="height: 30px;"  class="form-control"/>
                                    <%
                                    } else {
                                    %>
                                    <input type="text" name="char_description"  autocomplete="off" id="char_description" style="height: 30px;"  class="form-control" value="<%=gData.getCharactorTfDes()%>"/>
                                    <%
                                        }
                                    %>
                                    <!--                                    <input type="text" name="char_description"  autocomplete="off" id="char_description" style="height: 30px;"  class="form-control"/>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <%
                                        if (gData.getTogValue() == null) {
                                    %>
                                    <input class="form-control" list="tog_list" name="tog_value" id="tog_value" style="width: 100%; height: 30px;" placeholder="Tog Value"/>
                                    <%
                                    } else {
                                    %>
                                    <input class="form-control" list="tog_list" name="tog_value" id="tog_value" style="width: 100%; height: 30px;" placeholder="Tog Value" value="<%=gData.getTogValue()%>"/>
                                    <%
                                        }
                                    %>
                                    <!--                                    <input class="form-control" list="tog_list" name="tog_value" id="tog_value" style="width: 100%; height: 30px;" placeholder="Tog Value"/>-->
                                    <datalist id="tog_list">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <%
                                        if (gData.getSeasonCode() == null) {
                                    %>
                                    <input type="text" name="season_code"  autocomplete="off" id="season_code"  style="height: 30px;"  class="form-control"/>
                                    <%
                                    } else {
                                    %>
                                    <input type="text" name="season_code"  autocomplete="off" id="season_code"  style="height: 30px;"  class="form-control" value="<%=gData.getSeasonCode()%>"/>
                                    <%
                                        }
                                    %>
                            ...
                            <!--                            <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                            <%
                                if (gData.getCartoonDimention() == null) {
                            %>
                            <input type="text" name="carton_dimensions" id="carton_dimensions" autocomplete="off" style="height: 30px;"  class="form-control"/>
                            <%
                            } else {
                            %>
                            <input type="text" name="carton_dimensions" id="carton_dimensions" autocomplete="off" style="height: 30px;"  class="form-control" value="<%=gData.getCartoonDimention()%>" />
                            <%
                                }
                            %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <%
                                        if (gData.getAdditionalComment() == null) {
                                    %>
                                    <input type="text" name="comments" id="comments"  autocomplete="off" style="height: 30px;"  class="form-control"/>
                                    <%
                                    } else {
                                    %>
                                    <input type="text" name="comments" id="comments"  autocomplete="off" style="height: 30px;"  class="form-control" value="<%=gData.getAdditionalComment()%>"/>
                                    <%
                                        }
                                    %>
                                    <!--                                    <input type="text" name="comments" id="comments"  autocomplete="off" style="height: 30px;"  class="form-control"/>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <%
                                        if (gData.getCustomerPo() == null) {
                                    %>
                                    <input type="text" name="customer_po" id="customer_po"  autocomplete="off" style="height: 30px;"  class="form-control" value=""/>
                                    <%
                                    } else {
                                    %>
                                    <input type="text" name="customer_po" id="customer_po"  autocomplete="off" style="height: 30px;"  class="form-control" value="<%=gData.getCustomerPo()%>"/>
                                    <%
                                        }
                                    %>
                                    <!--                                    <input type="text" name="customer_po" id="customer_po"  autocomplete="off" style="height: 30px;"  class="form-control" value=""/>-->
                ...
                <input id="btn_tab1_next" class="btn btn-primary pull-right" type="button" name="submit" value="Next" onclick="tab1_next()" style="margin: 25px;" disabled="true" />
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group" style="width: 100%;">
                                        <input type="text" class="form-control" name="ean_no" id="ean_no" placeholder="EAN Number" style="width: 100%;" onkeypress="return checkForSecondDecimal(this, event);" onblur="checkExistEAN();">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group"> 
                                        <input type="text" class="form-control" name="uk_size" id="uk_size" list="uk_prim_size" placeholder="UK Size" style="width: 100%;" readonly="">
                                        <datalist id="uk_prim_size">                             
                                            <option disabled="" selected=""> - Primary Size - </option>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group"> 
                                        <input type="text" class="form-control" name="ce_size" id="ce_size" list="ce_prim_size" placeholder="CE Size" width="100%" style="width: 100%;" readonly="">
                            ...
                            <br>
                            <div class="row">
                                <div id="checkboxlist" style="padding-left: 75px;">
                                    <div class="row" id="secView" style="display: block;"><div class="col-lg-2 form-inline"><div class="form-group"><input type="checkbox" class="form-control" name="secSizeCheck" value="Height" id="Height"><label class="control-label"> &nbsp; &nbsp;Height</label></div></div><div class="col-lg-2 form-inline"><div class="form-group"><input type="checkbox" class="form-control" name="secSizeCheck" value="Chest" id="Chest"><label class="control-label"> &nbsp; &nbsp;Chest</label></div></div><div class="col-lg-2 form-inline"><div class="form-group"><input type="checkbox" class="form-control" name="secSizeCheck" value="Waist" id="Waist"><label class="control-label"> &nbsp; &nbsp;Waist</label></div></div></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="row">
                                <input type="button" id="addToTable1" value="Add to Table [1]" id="Add_to_Table" class="btn btn-primary pull-right" style="width: 100%; margin: 5px;" onclick="addEanTable();">
                            </div>
                            <div class="row">
                                <input type="button" value="Select Secondary Sizes [2]" id="Secondary_Sizes" class="btn btn-primary pull-right" style="width: 100%; margin: 5px;" onclick="checkSecSizeSelectedOrNot()">
                            </div>
                            <div class="row">
                                <input type="button" value="Save EAN No &amp; Sizes [3]" id="Save_EAN" class="btn btn-primary pull-right" style="width: 100%; margin: 5px;" onclick="getEanDetail()">
                            </div>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover table-bordered" width="100%" id="eanTable">
                    ...
                    <tbody style="text-align: center;">
                        <%
                            for (LofEandata data : eanSendList) {
                                if (data.getSecSize1() != null) {
                        ...
                        <tr>
                            <td>
                                <% String tmp = data.getUk().trim();
                                    if (tmp.equals("Free Type")) {
                                %>
                                <input type="checkbox" id="<%=data.getUk().trim()%>" disabled name="chk_ean" checked="true"/>
                                <%
                                } else {
                                %>
                                <input type="checkbox" id="<%=data.getUk().trim()%>" disabled name="chk_ean" checked="true" />
                            ...
                            <td>  
                                <%
                                    if (data.getEANNoce() != null && data.getEANNouk() != null) {
                                        out.print(data.getEANNouk().trim() + "/" + data.getEANNoce().trim());
                                    } else if (data.getEANNouk() != null) {
                                        out.print(data.getEANNouk().trim());
                                    } else {
                                        out.print(data.getEANNoce().trim());
                                    }
                                %>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <%
                                    if (data.getSecSize1() != null) {
                                        out.print(data.getSecSize1());
                                    }
                                    if (data.getSecSize2() != null) {
                                        out.print(" /" + data.getSecSize2());
                                    }
                                    if (data.getSecSize3() != null) {
                                        out.print(" /" + data.getSecSize3());
                                    }
                                    if (data.getSecSize4() != null) {
                                        out.print(" /" + data.getSecSize4());
                                    }
                                %>
                            </td>
                            <td>
                            ...
                            <td width="5%">
                                <span id="<%=data.getUk().trim()%>" name="<%=data.getUk().trim()%>" class="btn btn-default glyphicon glyphicon-remove text-center"></span>
                            </td>
                        </tr>
                        <%
                            }
                ...
                <div class="panel-body">
                    <table border="0" class="table table-hover table-responsive">                
                        ...
                        <tbody>
                                ...
                                <td colspan="2" style="padding-top: 20px;">
                                    <div class="row-fluid">
                                        <div class="col-lg-6">
                                            ...
                                            <br/>
                                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                                <button class="btn btn-primary pull-right" type="button" style="margin-bottom: 30px; height: 30px;" onclick="addTechFireWarnings();">Add</button>
                                            </div>
                                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                            ...
                                            <br/>
                                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                                <button class="btn btn-primary pull-right" type="button" style="margin-bottom: 30px; height: 30px;" onclick="addTechWarning();">Add</button>
                                            </div>
                                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                            ...
                            <tr>
                                <td colspan="2" bg
                                    ="#EFEFEF" style="font-size: 110%;">&nbsp;&nbsp;&nbsp;<span><i class="glyphicon glyphicon-arrow-right"></i></span>&nbsp;<strong>Wash Symbol</strong></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="padding-top: 20px;">
                                    <div class="row-fluid">
...
<script type="text/javascript">
    ...
    function loadTechIron() {
        isTechSaved = false;         var val = document.getElementById("techWash_I").value;
    ...
    function loadSwingDryClean() {
        var val = document.getElementById("swingWash_C").value;
            document.getElementById("sdisbleRef()wingWashTxt_C").value = val;
    ...
    $("#swingWash_W").focus();
        ...
        document.getElementById("swingWash_B").selectedIndex = 0;         document.getElementById("swingWash_I").selectedIndex = 0;
    ...
    function  btnTechWashClear() {
        ...
        for (var i = 1; i < techWash_C.length; i++) {             techWash_C[i].disabled = false;
        }
        ...
        document.getElementById("techWash_C").disabled = false;         document.getElementById("techWash_W").selectedIndex = 0;
    ...
    document.getElementById("techWashTxt_W").value = "";
        ...
        document.getElementById("techWashTxt_C").value = "";
            ...
            $("#techWashImg_B").attr("src", "");
                $("#techWashImg_I").attr("src", "");         $("#techWashImg_D").attr("src", "");
    ...
    function checkDigit(ean) {
            var final_digit = ean.substring(ean.length - 1, ean.length);

    var totalVal = 0;
    for (var i = 1; i < ean.length + 1; i++) {
        var current_digit = ean.substring(i - 1, i);
        if (i % 2 == 0) {
                totalVal += current_digit * 3;
        } else {                 totalVal += current_digit * 1;
            }
        }
...
//        else
        ...
        var iii = "hidden_" + this.id;
            ...
            buttons: [{
                        label: 'Edit Label',
                cssClass: 'btn-primary',
                        action: function (dialogRef) {                         editTechLabel(iiii);
                    dialogRef.close();
                }
    }, {
    label: 'Delete Label',
        cssClass: 'btn-primary',         action: function (dialogRef) {
        deleteTechLabel(iiii);
            //                        displayTechnical(technical_labels);                         dialogRef.close();
                    }
                }, {
                label: 'Cancel', action: function (dialogRef) {
                    dialogRef.close();
                ...
                if (reply.message) {
                    ...
                    //                    tech_wash_symbol.selectedIndex = 0;                     document.getElementById("fiberComposition").value = 1;
    ...
    document.getElementById("counter_techlabel").value = "";
        ...
        xmlHttp.send();
            ...
            closable: false,
                    ...
                    label: 'Edit Label',
                    cssClass: 'btn-primary', action: function (dialogRef) {
                        editSwingLabel(swinglabelId);                         dialogRef.close();
                    }
                }, {
    label: 'Delete Label',
        cssClass: 'btn-primary',
        action: function (dialogRef) {
            delete swing_tickets[iiii];
                displaySwing(swing_tickets);                         dialogRef.close();
                    }
                }, {
                label: 'Cancel',
                action: function (dialogRef) {
        ...
        xmlHttp.onreadystatechange = function () {
                ...
                console.log(reply.tech_details);
                    ...
                    $("#technical").show();                     $('html, body').animate({
                        scrollTop: $("#technical").offset().top - 60},
                    'slow', function () {
                    $("#technical").focus();
                        });
                    ...
                    row.appendChild(col1);
                        ...
                        temp_technical_care[ct_code] = tempTechCare;                                 tblTechCare.appendChild(row);
                            }
                        }
                    });
                    ...
                    for (var i = 0; i < tech_fiber.length; i++) {
                        ...
                        temp_technical_fiber["Fiber Composition : " + mainword] = tech_fiber[i];                         $("#mainWord option[value='" + mainword + "']").prop('disabled', true);
                            if (mainword == "None") {
                        ...
                        var tbl_fiberCompo = document.getElementById('tbl_fiberCompo').getElementsByTagName('tbody')[0];                         var row = document.createElement("tr");
...
//        $("#btn_addFiber").prop('disabled', true);
    ...
    document.getElementById("fiberQuantity").placeholder = "Remain Amount : " + (parseInt(document.getElementById("txt_fiberQuantity").value) + parseInt(this.name));
        ...
        console.log("delete ");
        console.log(temp_technical_fiber);
//        alert("length   :"+Object.keys(temp_technical_fiber).length);
        //        for (var i = 0; i < Object.keys(temp_technical_fiber).length; i++) {
    //            var abc =  temp_technical_fiber[i];
        //            alert("i = :"+i+":  "+abc);
//            var tmp =[];
        //            tmp = abc.split(":");
    ...
    //            var tmp2 = tmp[0].trim();            
        //            if (tmp2 == this.name) {
        //                alert("delete"); //                delete temp_technical_fiber[i];
        //            }else{
//            }
//        }
        console.log("vccran");
...
<script type="text/javascript">
    ...
    function checkGeneral() {
        ...
        var country_of_origin = document.getElementById('country_of_origin').value.trim();
                    var Brand = document.getElementById('Brand').value.trim(); //        var char_description = document.getElementById('char_description').value.trim();
        var char_description = "";
                ...
                if (style > 0) {
                    if (style === 1) {                 if (purchase_order_uk === "" || purchase_order_uk === null) {
            ...
            return;
                    ...
                    if (purchase_order_ce === "" || purchase_order_ce === null) {
                        BootstrapDialog.alert('Purchase Order is Required.', function () {
                            $('html, body').animate({
                            scrollTop: $("#po_ce").offset().top - 125},                         'slow', function () {
                        $("#po_ce").focus();
                    });
...
<script type="text/javascript">
            ...
            function getAllPrimarySize() {
        var style_type = document.getElementById("style_type").value;
        document.getElementById("uk_prim_size").options.length = 1;
                document.getElementById("ce_prim_size").options.length = 1;         if (style_type === "uk") {
                $('input[name^=uk_siz]').attr("readOnly", false);
            $('input[name^=ce_siz]').attr("readOnly", true);
                }
        if (style_type === "ce") {
                    $('input[name^=uk_siz]').attr("readOnly", true);             $('input[name^=ce_siz]').attr("readOnly", false);         }
                    var xmlHttp1 = getAjaxObject();
    ...
    option1.value = allSize[0] + " --- " + allSize[1];
        ...
        xmlHttp1.send();
            ...
            sm_alert("EAN No is a require field.");
            return;
            } else if (uk_size === "" || uk_size === null) {
                sm_alert("UK Size is a require field.");
                    return;         } else if (ce_size === "" || ce_size === null) {
            sm_alert("CE Size is a require field.");
                    return;
        } else { 
                        var data = {};
            data["ean_no"] = ean_no;
                        ...
                        xmlHttp1.onreadystatechange = function ()
            {
                ...
                if (data == 0) {
            sm_alert("Fail");
            //                        document.getElementById("btn_add_tab").disabled = true;
        //                        document.getElementById("btn_add_sys").disabled = true;
                    } else if (data == 1) {
        sm_notify("Success");
        //                        document.getElementById("btn_add_tab").disabled = false;
        //                        document.getElementById("btn_add_sys").disabled = true;
        }

                }             };
        xmlHttp1.open("POST", "Controller?method=addEANDetail&dataList=" + dataList, true);
            xmlHttp1.send();
        }

            }

    function addEanTable() {
        var style_type = document.getElementById("style_type").value.trim();
            var ean_no = document.getElementById("ean_no").value.trim();
            var uk_size = document.getElementById("uk_size").value.trim();
            var ce_size = document.getElementById("ce_size").value.trim();
            ...
            sm_alert("UK Size is a require field.");
            return;
            } else if (ce_size === "" || ce_size === null) {
            sm_alert("CE Size is a require field.");
            return;
        } else {

            if (style_type == "combine") {
                ean_no = ean_no + "/" + ean_no;
            }
...
//            elem5.type = "text";
    ...
    row.appendChild(col4);
        ...
        document.getElementById("uk_size").value = "";
            document.getElementById("ce_size").value = ""; //            document.getElementById("btn_add_tab").disabled = true;
    ...
    function checkExistEAN() {
        ...
        if (final_digit != cnt) {
            ...
            for (var x = 0; x < table.rows.length; x++) {
                var rw = table.rows[x];
                var eanDetailNo = rw.cells[1].innerHTML.trim();
                    if (ean_no.trim() === eanDetailNo) {
                    isExist = true;
                break;
            }
        }
            ...
            xmlHttp1.onreadystatechange = function ()
            {
                if (xmlHttp1.readyState === 4 && xmlHttp1.status === 200)
                {
                    $("#addToTable1").removeAttr("disabled");
                        var data = eval('(' + xmlHttp1.responseText + ')');
                    var message = data.message;
                        if (message === 1) {
                        document.getElementById("uk_size").value = data.ean_details.uk_size;
                        document.getElementById("ce_size").value = data.ean_details.ce_size;
                        //                        document.getElementById("btn_add_sys").disabled = true;
            //                        document.getElementById("btn_add_tab").disabled = false;
                    } else if (message === 0) {
    document.getElementById("uk_size").readOnly = false;
        document.getElementById("ce_size").readOnly = false;
        //                        document.getElementById("btn_add_sys").disabled = false;
        //                        document.getElementById("btn_add_tab").disabled = true;
            sm_warning("Please add relevent Primary Sizes.");                     }
 
            }
                };
                xmlHttp1.open("POST", "Controller?method=checkExistEAN&ean_no=" + ean_no, true);
            xmlHttp1.send();
        }
    }
    ...
    function getEanDetail() {
        ...
        if (eanchkCount !== checkboxes) {
            ...
            if (eanchkCount <= 0) {
            sm_alert("Please add atleast one EAN to verify");
            isEANSaved = false;
            return;
        }
        ...
        eanDetail["uk_size"] = ukPrime.trim();             eanDetail["ce_size"] = cePrime.trim();
        eanDetail["department"] = dept.trim();             eanDetail["quantity"] = tblquantity.value.trim();
            //            eanDetail["color"] = tblcolor.value.trim();
                eanDetail["secSize"] = secSize;             ean_det[ean] = eanDetail;
                }
    ...
    BootstrapDialog.show({
    title: 'Notification',
        type: BootstrapDialog.TYPE_WARNING,                         size: BootstrapDialog.SIZE_SMALL,
        message: 'Fail'
                    });
                }
        }
...
<script type="text/javascript">
    ...
    elem1.name = ct_name;
        ...
        row.appendChild(col3);
            ...
            tempTechCare["ct_name"] = ct_name;
            temp_technical_care[ct_code] = tempTechCare;
        tblTechCare.appendChild(row);         techFireWarnings.options.selectedIndex = 0;
    }
    ...
    function addFiber() {
        ...
        var fiberQuantity = document.getElementById("fiberQuantity").value;
            ...
            var fiberCount12 = parseInt(document.getElementById("fiberQuantity").value);
            if ((fiberType.selectedIndex === 0) && (fiberQuantity === "" || fiberQuantity === null)) {
            sm_alert("Please enter Fiber Type & Fiber Quantity.");             document.getElementById("fiberName").focus();
            return;
        ...
        document.getElementById("txt_mainWord").value = mainWord;             document.getElementById("mainWord").disabled = true;
        }
        var tblTechFiber = document.getElementById('tblFiber').getElementsByTagName('tbody')[0];
        var row = document.createElement("tr");
        row.id = fiberType;         var col2 = document.createElement("td");
        col2.type = "text";
        ...
        document.getElementById("fiberQuantity").value = "";
        document.getElementById("fiberQuantity").placeholder = "Remain Amount : " + remainQuantity;         document.getElementById("txt_fiberQuantity").value = remainQuantity;
        document.getElementById("fiberName").selectedIndex = 0;
        if (remainQuantity === 0) {
    ...
    function addFiberCompo() {
        ...
        var col3 = document.createElement("td");
        var elem1 = document.createElement("span");         elem1.id = "Fiber Composition : ";
            elem1.name = temp_fiberDetail["mainword"];
        elem1.type = "button";
        elem1.className = "btn btn-default glyphicon glyphicon-remove text-center";         col3.appendChild(elem1);
        row.appendChild(col2);
        row.appendChild(col3);
        tbl_fiberCompo.appendChild(row);
    ...
    function clearTechLabel() {
        ...
        document.getElementById("techcareInfo").selectedIndex = 0;
        document.getElementById("fiberComposition").value = 1;
        document.getElementById("txt_mainWord").value = "";         document.getElementById("mainWord").selectedIndex = 0;
        document.getElementById("mainWord").disabled = false;
        document.getElementById("fiberName").selectedIndex = 0;
        document.getElementById("fiberName").disabled = false;
        document.getElementById("fiberQuantity").value = "";
        ...
        for (var i = 1; i < caretext.length; i++) {             caretext[i].disabled = false;
        }
    ...
    function addTechLabel() {
        ...
        var techFiberCount = Object.keys(temp_technical_fiber).length;
            ...
            sm_alert("Please Enter Label Reference");
                $('html, body').animate({
    ...
    BootstrapDialog.show({
        ...
        message: 'Fail'
            ...
            function displayTechnical(technicallabels) {
                ...
                document.getElementById("techCount").innerHTML = "No of Concertina Labels : " + techLabelCount;         if (techLabelCount > 0) {
                isTechSaved = true;
                isEANSaved = true;
                var fico = [];
            fico[0] = "";
            ...
            fico[5] = "";
                ...
                techTabel.className = "table table-bordered table-striped";                 techTabel.width = "100%";
                ...
                var techRow6 = document.createElement("tr");                 var techRow7 = document.createElement("tr");
                var techRow8 = document.createElement("tr");                 var techRow9 = document.createElement("tr");
...
<script type="text/javascript">
        ...
        if (rawCount === 3) {             sm_warning("Maximum Care Count Reached.");
    ...
    function addSwingFireWarnings() {
        ...
        if (swingFireWarnings.selectedIndex === 0) {             sm_warning("Please select a Care Text");
    ...
    function addSwingChild() {
        var tempSwingCare = {};
        var tblSwingCare = document.getElementById('tblSwingCare').getElementsByTagName('tbody')[0];
        var swingChild = document.getElementById('swingChild');         if (swingChild.selectedIndex === 0) {
        sm_warning("Please select a Care Text");
        document.getElementById("swingcareInfo").focus();
            return;
        }
    ...
    elem1.name = ct_name;
        ...
        'slow', function () {
            ...
            sm_alert("Garment Type is a required field.");
                $('html, body').animate({
            ...
            sm_alert("Label Description is a required field.");
                $('html, body').animate({
    ...
    function displaySwing(swingTickets) {
                $("#swingView").empty();         var swingTicketCount = Object.keys(swingTickets).length;
        ...
        if (swingTicketCount > 0) {
                ...
                var swingRow2 = document.createElement("tr");                 var swingRow3 = document.createElement("tr");
                ...
                elem2.id = key;
                elem2.value = "Options";
                elem2.name = "swing_ticket";                 elem2.type = "button";
                elem2.className = "form-control btn btn-info";
    ...
    swingTbody.appendChild(swingRow1);
        ...
        swingTbody.appendChild(swingRow7);                 swingTabel.appendChild(swingTbody);
    ...
    document.getElementById("swing_labelRef_backId").readOnly = false;
            document.getElementById("swing_labelGroupId").readOnly = false;         document.getElementById("swing_lbl_des").readOnly = false;
            $("#sizeImage").attr("src", "");
            $("#tblSwingCare tbody").empty();         var swingCareCount = Object.keys(temp_swing_care).length;
            if (swingCareCount > 0) {
                for (var key in temp_swing_care) {
    ...
    message: 'Do you want to add this label details ?',
        ...
        draggable: true,
            btnCancelLabel: 'No',
            btnOKLabel: 'Yes',             callback: function (result) {
        if (result) {                     addSwingLabel();
        closeSwing();
                    clearSwing();
                } else {
                    return;
...
//        } 
    ...
    function tab3_next() {
            ...
            $("#tab_2").removeClass("active");
    $("#tab_3").removeClass("active");
            $("#tab_4").addClass("active");         $("#tab_5").removeClass("active");
