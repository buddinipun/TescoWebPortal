...
<html>
    ...
    <body style="overflow-y: auto;">
        ...
        <script type="text/javascript">
            document.title = "Page not Found | E-Platform"
        </script>
        ...
        <div id="content"> 
            ...
            <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-2" style="overflow-y: auto; ">
                <span>
                    <img class="img-responsive" src="/IEPTescoNew/img/not_found.gif" alt="Page not Found." />
                </span>
                <div style="width:100%;">
                    <form name="backtoadmin" action="/IEPTescoNew/index.jsp">
